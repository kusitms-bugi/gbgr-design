...
3. CI enforces checks on PRs: `pnpm check`, `pnpm typecheck`, `pnpm build`.
...
## Testing
1. Treat `pnpm check`, `pnpm typecheck`, and `pnpm build` as the required baseline verification for every PR.
